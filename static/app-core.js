...
const STATIC_ITEM_KEYS = Object.freeze([
  "divider_item",
  "has_tag_item",
  "no_tag_item",
  "exit_item",
...
function migrateLegacyConfig(rawInput) {
...
function buildExportObject(config, mode = "full") {
  if (mode === "tags") {
...
function dumpConfigYaml(config, yamlLib, mode = "full") {
...
function parseConfigYaml(text, yamlLib) {
...
function parseSlotList(value, menuSize = 54) {
...
function findUnsupportedMiniTags(text) {
...
function validateConfig(config, yamlError = null) {
  const issues = [];
  if (yamlError) {
...
function tagCanSelect(tag, preview = {}) {
...
function selectableCategories(config, preview) {
...
function replacePlaceholders(text, context = {}, config = DEFAULT_CONFIG) {
...
function formatTextSegments(text, config = DEFAULT_CONFIG) {
...
function formatTextHtml(text, config = DEFAULT_CONFIG) {
...
function buildPreview(config, previewInput = DEFAULT_PREVIEW) {
...
function materialToTextureId(material) {
...
function iconCandidates(material, template = DEFAULT_ICON_TEMPLATE) {
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = DeluxeTagsCore;
}

if (typeof globalThis !== "undefined") {
  globalThis.DeluxeTagsCore = DeluxeTagsCore;
}
